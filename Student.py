...
command=self.add_student).grid(row=3, column=0)
 tk.Button(root, text="View Students", 
command=self.view_students).grid(row=3, column=1)
 tk.Button(root, text="Clear", command=self.clear_entries).grid(row=3, 
column=2)
